...
{
    public class myCsub_Progress : ContentPage
    {
        ...
        public myCsub_Progress()
        {
            NavigationPage.SetHasNavigationBar(this, false);
            Title = "myCSUB Parking Progress";
            ...
            var footerLayout = new StackLayout
            {
                ...
                Children = 
                {
                    ...
                    new Label 
                    {
							Text = "myCSUB Parking 10.5"
					}
                }
            };
            BackgroundImage = "Runner2.jpg";
